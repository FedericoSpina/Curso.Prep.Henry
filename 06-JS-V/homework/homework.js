...
function agregarStringInvertida() {
  ...
  String.prototype.reverse = function () {
    ...
    for (let i = 0; i < this.length; i++) {
      // empieza de 0 , lo va leyendo y termina hasta la ultima posicion de la palabra en si
      palabrainvertida.unshift(this[i]); // unshift agarre el ultimo elemento del string y lo coloca al principio
    }
